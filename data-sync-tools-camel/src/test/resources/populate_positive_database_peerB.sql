...
values ('151EFA13-A3AD-4C18-A2CE-9D66D0AED112', '0934A378-DEDB-4207-B99C-DD0D61DC59BC', '5155FFA2-DBA3-4A37-B72E-F9AC7065F599');

insert into org.ContactLink(sourceContactId, targetContactId, workHistoryId)
values ('151EFA13-A3AD-4C18-A2CE-9D66D0AED112', '0934A378-DEDB-4207-B99C-DD0D61DC59BC', '79C54C95-23E0-4A4D-B85A-652599EAE966');

insert into org.ContactLink(sourceContactId, targetContactId, workHistoryId)
values ('0934A378-DEDB-4207-B99C-DD0D61DC59BC', '6869F4EC-09BB-4FED-A1A7-B446D2C63BAF', 'C63DFAC4-658A-4D05-9D01-1C01EF5B732E');

insert into org.ContactLink(sourceContactId, targetContactId, workHistoryId)
values ('6869F4EC-09BB-4FED-A1A7-B446D2C63BAF', '0934A378-DEDB-4207-B99C-DD0D61DC59BC', 'E30344DA-6290-4A46-83FC-CAB6E5119BD4');
