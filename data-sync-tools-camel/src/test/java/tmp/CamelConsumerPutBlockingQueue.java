...
public class CamelConsumerPutBlockingQueue extends AbstractPartialBlockingQueue
	implements BlockingQueue<String> {

    private static final Logger LOG = LoggerFactory
	    .getLogger(CamelConsumerPutBlockingQueue.class);
    ...
    public CamelConsumerPutBlockingQueue(ConsumerTemplate template, String uri,
