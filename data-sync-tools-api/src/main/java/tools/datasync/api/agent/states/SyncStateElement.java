...
package tools.datasync.api.agent.states;
...
public class SyncStateElement implements Serializable, Cloneable {
    ...
    public static final SyncStateElement SEEDING = new SyncStateElement(
	    "SEEDING");

    public static final SyncStateElement ANALYZING = new SyncStateElement(
	    "ANALYZING");

    public static final SyncStateElement WAITING = new SyncStateElement(
	    "WAITING");

    public static final SyncStateElement RESOLVING = new SyncStateElement(
	    "RESOLVING");

    public static final SyncStateElement SYNCING = new SyncStateElement(
	    "SYNCING");

    public static final SyncStateElement INVALID = new SyncStateElement(
	    "INVALID");
    // ------------------------------------------------
	...
	if (obj instanceof SyncStateElement) {
	    if (this.syncState
		    .equalsIgnoreCase(((SyncStateElement) obj).syncState)) {
		return true;
	    }
	}
	return false;
